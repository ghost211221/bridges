# Generated by Django 2.2 on 2019-10-12 16:32
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('productsapp', '0002_auto_20191011_1824'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.DecimalField(decimal_places=2, max_digits=18, null=True, verbose_name='ОБъем работ')),
                ('is_active', models.BooleanField(default=True, verbose_name='Показывать')),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ...
                ('techsol', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='productsapp.TechnicalSolutions', verbose_name='Техническое решение')),
            ],
            options={
